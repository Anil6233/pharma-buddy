...
class MedicinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create medicine" do
    assert_difference('Medicine.count') do
      post medicines_url, params: { medicine: { cost: @medicine.cost, expiry_date: @medicine.expiry_date, manufacturer_date: @medicine.manufacturer_date, name: @medicine.name, quantity: @medicine.quantity } }
    end
  ...
  test "should update medicine" do
    patch medicine_url(@medicine), params: { medicine: { cost: @medicine.cost, expiry_date: @medicine.expiry_date, manufacturer_date: @medicine.manufacturer_date, name: @medicine.name, quantity: @medicine.quantity } }
